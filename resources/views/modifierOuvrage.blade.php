        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Modifier ouvrage</h4>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      ...
      @if(isset($livre) && $livre->image)
        <div class="mt-2">
        <img src="{{ url('assets/images/' . $livre->image) }}" alt="{{ $livre->titre }}" width="150">
