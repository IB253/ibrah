      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          ...
          <div class=" mt-0 mt-md-5">
          	<form action="{{ route('ajout_programme.create') }}" class="request-form ftco-animate" enctype="multipart/form-data" method="post">
          	@csrf	
            <h2>Ajouter un Programme</h2>
    					...
    					<div class="form-group">
	    					<input type="number" name="duree" class="form-control" placeholder="Duree (mois )">
	    				</div>
    					<div class="form-group">
