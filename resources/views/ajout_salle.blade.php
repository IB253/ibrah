        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                ...
                <div class=" mt-0 mt-md-5">
                    <form action="{{ route('ajout_salle.create') }}" enctype="multipart/form-data" class="request-form ftco-animate" method="post">
                        @csrf
                        <h2>Ajouter une Salle</h2>
                        <div class="form-group">
                            <input type="number" name="capacite" class="form-control" placeholder="Capacite (etudiants)">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Ajouter" class="btn btn-primary py-3 px-4">
                        </div>
                    </form>
                </div>
            </div>
