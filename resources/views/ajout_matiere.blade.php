      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          ...
          <div class=" mt-0 mt-md-5">
          	<form action="{{ route('ajout_matiere.create') }}" class="request-form ftco-animate" method="post">
          	@csrf	
            ...
            <div class="form-group">
    					...
    					<div class="form-group">
	    					<input type="number" name="duree" class="form-control" placeholder="Duree (heures)">
	    				</div>
                        <div class="form-group">
